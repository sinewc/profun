...
private:
	...
	public:
			  ...
			  animationTimer(animation_timer),width(width),height(height)
		{
			...
			this->endRect = sf::IntRect(start_frames_x * width, start_frames_y * height, width, height);
...
public:
	...
	//Functions
	void addAnimation(const std::string key, sf::Sprite& sprite, sf::Texture& textureSheet,
		float animation_timer,
		int start_frames_x, int start_frames_y, int frames_x, int frames_y, int width, int height);
